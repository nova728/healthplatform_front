...
.stat-card:nth-child(1)::before {
  background: #3b82f6;  /* 主蓝色 */
}

/* 最高心率卡片 */
.stat-card:nth-child(2) {
  background: linear-gradient(145deg, #ffffff 0%, rgba(37, 99, 235, 0.05) 100%);
}
...
.stat-card:nth-child(3) {
  background: linear-gradient(145deg, #ffffff 0%, rgba(96, 165, 250, 0.05) 100%);
}
...
.stat-card:nth-child(4) {
  background: linear-gradient(145deg, #ffffff 0%, rgba(147, 197, 253, 0.05) 100%);
}

.stat-card:nth-child(4)::before {
  background: #93c5fd;  /* 最浅蓝色 */
}
